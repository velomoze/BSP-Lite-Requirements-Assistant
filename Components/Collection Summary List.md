![](https://confluence.churchofjesuschrist.org/download/attachments/338985353/image-2026-5-20_9-44-1.png?version=1&modificationDate=1779291841903&api=v2)

![](https://confluence.churchofjesuschrist.org/download/thumbnails/338985353/image-2026-5-20_9-44-22.png?version=1&modificationDate=1779291862123&api=v2)
...
- Choose the location of the Button
    - Single select dropdown
...
Hover: hand pointer cursor and the title text changes to blue text.

  

### Front End Functional Requirements

- This collection is limited to displaying one row of 4 tiles.