![](https://confluence.churchofjesuschrist.org/download/attachments/309299900/image-2025-12-30_13-35-49.png?version=1&modificationDate=1767126949993&api=v2)
...
- Component Width 
    ...
    - Default is Read
- Show Caption (boolean, default to false)
- Show Credit (boolean, default to false)
- Show Title (boolean, default to false)
- Vertical Spacing
    - Single select dropdown
...
Arrow Hover: cursor changes to pointer hand.
