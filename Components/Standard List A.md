![](https://confluence.churchofjesuschrist.org/download/attachments/309299602/image-2025-12-30_8-14-23.png?version=1&modificationDate=1767107663690&api=v2)

![](https://confluence.churchofjesuschrist.org/download/attachments/309299602/image-2026-5-15_10-30-35.png?version=1&modificationDate=1778862635217&api=v2)
...
- Image Position Horizontal
    ...
    - Default is Left
- Hide Images (boolean, default to false)
- Component Width 
    - Single select dropdown
...
- Heading Text Alignment
    ...
    - Default is Start
- Hide Pretitle (boolean, default to false)

  

### States

CTA Button hover: Primary button background color changes to a different shade of blue and the cursor changes to a pointer hand. Secondary button just has the pointer hand cursor.
