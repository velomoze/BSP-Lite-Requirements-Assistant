## ![](https://confluence.churchofjesuschrist.org/download/attachments/335398570/image-2026-5-15_11-12-33.png?version=1&modificationDate=1778865153473&api=v2)

![](https://confluence.churchofjesuschrist.org/download/thumbnails/335398570/image-2026-5-15_11-12-3.png?version=1&modificationDate=1778865123360&api=v2)

  

This component has not been updated to GSVG standards.
...
- Component Width 
    - Single select dropdown 
    - Options are Read (672px), Pop (1024px), Plus (1600px), and Edge (100%)
    - Default is Pop
- Vertical Spacing
    - Single select dropdown
...
Hover: Title color changes to blue, cursor changes to hand pointer.

  

### Front End Functional Requirements

- The title and description of the first item are displayed on top of the image.