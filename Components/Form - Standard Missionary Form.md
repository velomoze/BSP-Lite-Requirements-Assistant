![](https://confluence.churchofjesuschrist.org/download/attachments/338985466/image-2026-5-20_12-53-53.png?version=1&modificationDate=1779303233627&api=v2)
...
- Option Type
    ...
    - Missionary is set up with formTopicId, sourceId, and offerItemIds
- Choice
    - Single select dropdown
...
- Opacity value for the overlay (number from 0 to 100)
    - plain text, not required
- Use Condensed Layout (boolean, default is false)
...
Active field: Blinking cursor in the field. Placeholder text is moved to the top of the field with animation.
...
- Missionary Address includes auto-complete service through a third party system.
- Missionary Address includes address validation through a third party system.
- Missionary Email includes email validation through a third party system.
- Missionary phone number includes phone number validation and formatting through libphonenumber.js
- Missionary Country Select field uses a country list from Missionary.